...
namespace SampleWebApp.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            IEnumerable<UserInfoModel> uiListModel;

            uiListModel = await HttpClientHelper.GetUserInfoList();

            ICollection<DaysOfWeek> dowList = await HttpClientHelper.GetDaysOfWeek();

            foreach (var item in uiListModel)
            {
                item.DaysOfWeek = dowList;
            }

            ParentIndexViewModel parentModel = new ParentIndexViewModel
            {
                IndexViewModel = model,
                UserInfoModelCollection = uiListModel ?? new List<UserInfoModel>()
            };
